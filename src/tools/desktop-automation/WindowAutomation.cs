...
internal static class WindowAutomation
{
        ...
        WindowSelectionState? selectionState = null)
    {
        ...
        throw new InvalidOperationException(
            "No window was supplied and no window is currently selected. Use list_windows followed by activate_window first.");
    }
    ...
    private static nint ResolveWindowByTitle(string titleContains)
    {
        ...
        LogTrace(
            "activate_window.resolve_by_title",
