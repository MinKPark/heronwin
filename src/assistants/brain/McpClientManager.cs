...
internal sealed class McpClientManager : IAsyncDisposable
{
    ...
    public async Task ConnectAsync(IReadOnlyList<McpServerConfig> servers, CancellationToken cancellationToken)
    {
        ...
        _envBaseDir = Environment.GetEnvironmentVariable("HERONWIN_ENV_DIR")
    ...
    private static Dictionary<string, object?> CloneArguments(IReadOnlyDictionary<string, object?> arguments)
