...
Use `TARS_AGENT_DEFINITION_PATH` or `CURSOR_AGENT_DEFINITION_PATH` for assistant-specific overrides. `AGENT_DEFINITION_PATH` remains as a shared compatibility fallback.
