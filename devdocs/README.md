# HeronWin Developer Docs

These docs cover project design, development guardrails, bugs, performance notes, and historical work summaries.
...
- [AVA Role-Specific LLM Config Plan](./designs/ava-role-specific-llm-config-plan.md)
...
- [Netflix Smoke Runtime Performance Plan](./designs/netflix-smoke-runtime-performance-plan.md)
- [Scripted Cross-Turn Evidence Reuse Plan](./designs/scripted-cross-turn-evidence-reuse-plan.md)
- [Scripted Turn Lookahead Plan](./designs/scripted-turn-lookahead-plan.md)
- [Tools Cognition Execution Refactor](./designs/tools-cognition-execution-refactor.md)

## Bugs And Performance

- [Bug Docs](./bugs/README.md)
- [Performance Baselines](./perfbase/)

Historical docs may still mention older layouts or old path names when describing work that happened before the latest restructure. Live setup docs remain in [docs](../docs/README.md).
